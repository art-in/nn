...
- convolution (128 output channels, 3x3 kernel, 1 stride, 0 padding), ReLU activation
- batch normalization
- convolution (128 output channels, 3x3 kernel, 1 stride, 0 padding), ReLU activation
- batch normalization
- convolution (128 output channels, 5x5 kernel, 2 stride, 2 padding), ReLU activation
- batch normalization
- dropout (50%)

- flattening
- linear (256 neurons), ReLU activation
- dropout (50%)
